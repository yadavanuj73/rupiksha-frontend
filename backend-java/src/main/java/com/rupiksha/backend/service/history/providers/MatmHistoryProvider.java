...
@Slf4j
@Component
public class MatmHistoryProvider extends BaseHistoryProvider {

    private final TxnRepository txnRepository;

    public MatmHistoryProvider(WalletEntryRepository walletEntryRepository,
    ...
    public boolean supports(TransactionReportType reportType) {
        return reportType == TransactionReportType.MICRO_ATM;
    }
    ...
    public Page<TransactionHistoryResponseDto> fetchHistory(
        ...
        Page<Txn> txns = txnRepository.findWithFilters(
                userId, "MATM", false, txnStatus, provider, start, end, search, pageable);
    ...
    public List<TransactionHistoryResponseDto> fetchAllHistory(
        ...
        List<Txn> txns = txnRepository.findAllWithFilters(
                userId, "MATM", false, txnStatus, provider, start, end, search, sort);
