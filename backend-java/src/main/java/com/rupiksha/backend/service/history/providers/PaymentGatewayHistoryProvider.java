...
@Slf4j
@Component
public class PaymentGatewayHistoryProvider extends BaseHistoryProvider {

    private final TxnRepository txnRepository;

    public PaymentGatewayHistoryProvider(WalletEntryRepository walletEntryRepository,
    ...
    public boolean supports(TransactionReportType reportType) {
        return reportType == TransactionReportType.PAYMENT_GATEWAY;
    }
    ...
    public Page<TransactionHistoryResponseDto> fetchHistory(
        ...
        Page<Txn> txns = txnRepository.findWithFilters(
                userId, "WALLET_TOPUP", false, txnStatus, provider, start, end, search, pageable);
    ...
    public List<TransactionHistoryResponseDto> fetchAllHistory(
        ...
        List<Txn> txns = txnRepository.findAllWithFilters(
                userId, "WALLET_TOPUP", false, txnStatus, provider, start, end, search, sort);
