...
import com.example.Rupiksha.Fingpay.dto.AadhaarPayRequest;
import com.example.Rupiksha.Fingpay.dto.AadhaarPayResponse;
...
public class AadhaarPayService {
    ...
    public AadhaarPayResponse process(AadhaarPayRequest req) {
        ...
        try {
            ...
            log.debug("AP plain JSON: {}", plainJson);
            ...
            log.debug("AP raw response: {}", httpResp.getBody());
