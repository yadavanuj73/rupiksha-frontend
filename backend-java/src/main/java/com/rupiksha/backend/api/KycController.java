...
public class KycController {
    ...
    private Map<String, Object> toProfileMap(User user) {
        ...
        profile.put("businessType", user.getBusinessType() != null ? user.getBusinessType() : "Sole proprietorship");
        profile.put("gstNumber", user.getGstNumber());
        profile.put("gender", user.getGender() != null ? user.getGender() : "Male");
        profile.put("dob", user.getDob());
        profile.put("addressLine1", user.getAddressLine1() != null ? user.getAddressLine1() : user.getShopAddress());
        profile.put("address1", user.getAddressLine1() != null ? user.getAddressLine1() : user.getShopAddress());
        profile.put("address", user.getAddressLine1() != null ? user.getAddressLine1() : user.getShopAddress());
        ...
        profile.put("address2", user.getShopLandmark());
        profile.put("permanentAddress", user.getPermanentAddress() != null ? user.getPermanentAddress() : user.getAddressLine1());
        profile.put("residentialAddress1", user.getPermanentAddress() != null ? user.getPermanentAddress() : user.getAddressLine1());
        profile.put("residentialAddress2", user.getShopLandmark());
        profile.put("city", user.getCity() != null ? user.getCity() : user.getShopCity());
        profile.put("area", user.getCity() != null ? user.getCity() : user.getShopCity());
        profile.put("personalArea", user.getPermCity() != null ? user.getPermCity() : (user.getCity() != null ? user.getCity() : user.getShopCity()));
        profile.put("stateName", user.getStateName() != null ? user.getStateName() : user.getShopState());
        profile.put("state", user.getStateName() != null ? user.getStateName() : user.getShopState());
        profile.put("pincode", user.getPincode() != null ? user.getPincode() : user.getShopPincode());
        profile.put("personalPincode", user.getPermPincode() != null ? user.getPermPincode() : user.getPincode());
        ...
        profile.put("confirmAccountNumber", user.getBankAccountNumber());
