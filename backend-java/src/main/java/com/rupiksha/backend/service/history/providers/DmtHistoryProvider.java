...
@Slf4j
@Component
public class DmtHistoryProvider extends BaseHistoryProvider {

    private final TxnRepository txnRepository;

    public DmtHistoryProvider(WalletEntryRepository walletEntryRepository,
    ...
    public boolean supports(TransactionReportType reportType) {
        return reportType == TransactionReportType.MONEY_TRANSFER;
    }
    ...
    public Page<TransactionHistoryResponseDto> fetchHistory(
        ...
        Page<Txn> txns = txnRepository.findWithFilters(
                userId, "TRANSFER", false, txnStatus, provider, start, end, search, pageable);
    ...
    public List<TransactionHistoryResponseDto> fetchAllHistory(
        ...
        List<Txn> txns = txnRepository.findAllWithFilters(
                userId, "TRANSFER", false, txnStatus, provider, start, end, search, sort);
