...
export default function RetailerCommission() {
    ...
    const getPlanDisplayName = (plan) => {
        ...
        if (code === 'PLAN_7999' || name.includes('7999') || name.toLowerCase().includes('dhanbarsha')) return 'Rupksha Dhanbarsha Plan';
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="space-y-0.5 mb-2.5">
                                                    <h3 className="text-sm sm:text-base font-black text-slate-800 tracking-tight leading-snug truncate" title={planDisplayName}>
                                                        {planDisplayName}
                                                    </h3>
                                                    <div className="flex items-baseline gap-1.5 pt-0.5">
                                                        ...
                                                        {priceVal > 0 && (
                                                            <span className="text-[9.5px] font-black text-indigo-700 bg-indigo-50 border border-indigo-100 px-1.5 py-0.5 rounded uppercase tracking-wider">
                                                                / Year
                                                            </span>
                                                        )}
                                                    </div>
                                                ...
                                                <div className="space-y-1 py-2 border-y border-slate-100 text-[10.5px] mb-3">
                                                    <p className="text-[8.5px] font-black uppercase tracking-widest text-slate-400 mb-0.5">
                                                        Commission Rates:
                                                    </p>
                                                    {slabsList.slice(0, 6).map((slab, sIdx) => (
                                                        <div key={sIdx} className="flex items-center justify-between text-slate-600 font-mono leading-tight">
                                                    ...
                                                    {slabsList.length > 6 && (
                                                        <div className="flex items-center justify-between text-slate-600 font-mono leading-tight">
                                                            <span className="text-[10px]">
