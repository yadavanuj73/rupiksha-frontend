...
@Slf4j
@Component
public class CreditCardHistoryProvider extends BaseHistoryProvider {

    private final TxnRepository txnRepository;

    public CreditCardHistoryProvider(WalletEntryRepository walletEntryRepository,
    ...
    public boolean supports(TransactionReportType reportType) {
        return reportType == TransactionReportType.CREDIT_CARD_BILL;
    }
    ...
    public Page<TransactionHistoryResponseDto> fetchHistory(
        ...
        Page<Txn> txns = txnRepository.findWithFilters(
                userId, "CREDIT_CARD_BILL", false, txnStatus, provider, start, end, search, pageable);
    ...
    public List<TransactionHistoryResponseDto> fetchAllHistory(
        ...
        List<Txn> txns = txnRepository.findAllWithFilters(
                userId, "CREDIT_CARD_BILL", false, txnStatus, provider, start, end, search, sort);
