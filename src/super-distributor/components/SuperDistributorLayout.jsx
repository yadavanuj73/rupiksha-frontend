        ...
        <div className="h-screen bg-[#eef3ff] overflow-hidden font-['Inter',sans-serif]">
            ...
            <div className="h-full flex flex-col overflow-hidden min-w-0 pt-[76px] lg:ml-64">
                ...
                <div className="bg-blue-50 text-slate-700 h-9 flex items-center px-6 shrink-0 border-b border-blue-100">
                    <div className="flex items-center gap-6 w-full max-w-7xl mx-auto">
                        ...
                        <div className="flex-1 flex justify-end items-center gap-4">
                            ...
                            <span className="text-slate-400 text-[9px] font-black uppercase tracking-[0.2em] hidden sm:block">SUPER_DISTRIBUTOR Node v1.0</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white border-b border-slate-100 px-4 flex items-center gap-1 shrink-0 overflow-x-auto shadow-sm">
                    {[
                        { to: '/super-distributor', label: 'Dashboard', end: true },
                        { to: '/super-distributor/distributors', label: 'Distributors' },
                        { to: '/super-distributor/retailers', label: 'Retailers' },
                        { to: '/super-distributor/transactions', label: 'Transactions' },
                        { to: '/super-distributor/reports', label: 'Reports' },
                        { to: '/super-distributor/accounts', label: 'Accounts' },
                    ].map(({ to, label, end }) => (
                        <NavLink
                            key={to}
                            to={to}
